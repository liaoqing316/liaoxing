...
<form method="post" action="train_control.jsp">
    ...
    <div class="content-wrap">
        ...
        <table class="table table-responsive">
            ...
            <tbody>
            <tr>
                <td><input type="text" name="tName" style="width: 100%;"/></td>
                <td><input type="text" name="tSex" style="width: 100%;"/></td>
                <td><input type="text" name="tAge" style="width: 100%;"/></td>
                <th><input type="text" name="tDepartment" style="width: 100%;"/></th>
            </tr>
            </tbody>
        </table>
    </div>
