...
<%--
    ...
    <table class="table table-responsive">
        ...
        <table class="table table-responsive">
            ...
            <tbody>
            <tr>
                <td><input type="text" name="sName" style="width: 100%;"/></td>
                <td><input type="text" name="sSex" style="width: 100%;"/></td>
                <td><input type="text" name="sAge" style="width: 100%;"/></td>
                <th><input type="text" name="sDepartment" style="width: 100%;"/></th>
            </tr>
            </tbody>
        </table>
    </div>
